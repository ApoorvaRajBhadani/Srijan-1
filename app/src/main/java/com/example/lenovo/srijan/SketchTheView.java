...
public class SketchTheView extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("Sketch the View");
        notification();
        place();
        details();
        register();//new line
    ...
    private void details() {
        ...
        //todo:set context
        final Intent intent = new Intent(SketchTheView.this,Details.class);
        //todo:set context
        Dialog = new ProgressDialog(SketchTheView.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref.child("SketchTheView").addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    private void place() {
        ...
        //todo:set context
        placess = new AlertDialog.Builder(SketchTheView.this);//class ka name
        placess.setTitle("Venue");
        placess.create();
        //todo:set context
        progressDialog = new ProgressDialog(SketchTheView.this);
    ...
    private void init() {
        ...
        //todo:set context
        viewPager.setAdapter(new adapterimage(SketchTheView.this,imagesList));
