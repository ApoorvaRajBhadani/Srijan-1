...
public class Developers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        designersList.add(new DeveloperModel(R.drawable.ic_launcher_foreground,"Teesra Banda","B.Tech. 1st year","perul-jain-55845b154","https://github.com/peruljain","peruljain","perul.jain"));
