...
public class Filmmaking extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("24hours Film-making");
        notification();
        place();
        details();register();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus()){
                    ...
                    Toast.makeText(Filmmaking.this,"Please Check Your Internet Connection", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void details() {
        ...
        //todo:set context
        final Intent intent = new Intent(Filmmaking.this,Details.class);
        //todo:set context
        Dialog = new ProgressDialog(Filmmaking.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref.child("Filmmaking").addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    private void place() {
        ...
        //todo:set context
        placess = new AlertDialog.Builder(Filmmaking.this);//class ka name
        placess.setTitle("Venue");
        placess.create();
        //todo:set context
        progressDialog = new ProgressDialog(Filmmaking.this);
    ...
    private void init() {
        ...
        //todo:set context
        viewPager.setAdapter(new adapterimage(Filmmaking.this,imagesList));
