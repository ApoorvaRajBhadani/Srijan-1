...
public class Trichonia extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("Trichonia");
        notification();
        place();
        details();register();//
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus()){
                    ...
                    Toast.makeText(Trichonia.this,"Please Check Your Internet Connection", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void details() {
        ...
        //todo:set context
        final Intent intent = new Intent(Trichonia.this,Details.class);
        //todo:set context
        Dialog = new ProgressDialog(Trichonia.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref.child("Trichonia").addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    private void place() {
        ...
        //todo:set context
        placess = new AlertDialog.Builder(Trichonia.this);//class ka name
        placess.setTitle("Venue");
        placess.create();
        //todo:set context
        progressDialog = new ProgressDialog(Trichonia.this);
    ...
    private void init() {
        ...
        //todo:set context
        viewPager.setAdapter(new adapterimage(Trichonia.this,imagesList));
