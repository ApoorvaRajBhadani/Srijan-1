...
public class Hallabol extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("Hallabol");
        notification();
        place();
        details();
        register();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus()){
                    //todo:set context
                    Toast.makeText(Hallabol.this,"Unsubscribed from event's notifications",Toast.LENGTH_LONG).show();
                    imageView.setImageResource(R.drawable.bell);
                    FirebaseMessaging.getInstance().unsubscribeFromTopic("Hallabol");//Todo:event name
                    sharedPreferenceConfig.writeImagestatus(true);
                }else{

                    FirebaseMessaging.getInstance().subscribeToTopic("Unplugged");//Todo:event name
                    //todo:set context
                    Toast.makeText(Hallabol.this,"Successfully subscribed for notifications",Toast.LENGTH_LONG).show();
                    sharedPreferenceConfig.writeImagestatus(false);
                    imageView.setImageResource(R.drawable.chess);
                }
                }else{
                    Toast.makeText(Hallabol.this,"Please Check Your Internet Connection", Toast.LENGTH_LONG).show();
                }
    ...
    private void details() {
        ...
        //todo:set context
        final Intent intent = new Intent(Hallabol.this,Details.class);
        //todo:set context
        Dialog = new ProgressDialog(Hallabol.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref.child("Hallabol").addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    private void place() {
        ...
        //todo:set context
        placess = new AlertDialog.Builder(Hallabol.this);//class ka name
        placess.setTitle("Venue");
        placess.create();
        //todo:set context
        progressDialog = new ProgressDialog(Hallabol.this);
    ...
    private void init() {
        ...
        //todo:set context
        viewPager.setAdapter(new adapterimage(Hallabol.this,imagesList));
