...
public class Monoact extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("Monoact");
        notification();
        place();
        details();
        register();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus()){
                    ...
                    Toast.makeText(Monoact.this,"Please Check Your Internet Connection", Toast.LENGTH_LONG).show();
                }
            }
    ...
    private void details() {
        ...
        //todo:set context
        final Intent intent = new Intent(Monoact.this,Details.class);
        //todo:set context
        Dialog = new ProgressDialog(Monoact.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref.child("Monoact").addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    private void place() {
        ...
        //todo:set context
        placess = new AlertDialog.Builder(Monoact.this);//class ka name
        placess.setTitle("Venue");
        placess.create();
        //todo:set context
        progressDialog = new ProgressDialog(Monoact.this);
    ...
    private void init() {
        ...
        //todo:set context
        viewPager.setAdapter(new adapterimage(Monoact.this,imagesList));
