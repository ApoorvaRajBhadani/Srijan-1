...
public class BusinessQuiz extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        headingTextView.setText("Business Quiz");
        notification();
        place();
        details();
        register();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sharedPreferenceConfig.getstatus()){
                    //todo:set context
                    Toast.makeText(BusinessQuiz.this,"Unsubscribed from event's notifications",Toast.LENGTH_LONG).show();
                    imageView.setImageResource(R.drawable.bell);
                    FirebaseMessaging.getInstance().unsubscribeFromTopic("BusinessQuiz");//Todo:event name
                    sharedPreferenceConfig.writeImagestatus(true);
                }else{

                    FirebaseMessaging.getInstance().subscribeToTopic("BusinessQuiz");//Todo:event name
                    //todo:set context
                    Toast.makeText(BusinessQuiz.this,"Successfully subscribed for notifications",Toast.LENGTH_LONG).show();
                    sharedPreferenceConfig.writeImagestatus(false);
                    imageView.setImageResource(R.drawable.chess);
                }

                }else{
                    Toast.makeText(BusinessQuiz.this,"Please Check Your Internet Connection", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    private void details() {
        ...
        //todo:set context
        final Intent intent = new Intent(BusinessQuiz.this,Details.class);
        //todo:set context
        Dialog = new ProgressDialog(BusinessQuiz.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ref.child("BusinessQuiz").addValueEventListener(new ValueEventListener() {
                    @Override
    ...
    private void place() {
        ...
        //todo:set context
        placess = new AlertDialog.Builder(BusinessQuiz.this);//class ka name
        placess.setTitle("Venue");
        placess.create();
        //todo:set context
        progressDialog = new ProgressDialog(BusinessQuiz.this);
    ...
    private void init() {
        ...
        //todo:set context
        viewPager.setAdapter(new adapterimage(BusinessQuiz.this,imagesList));
