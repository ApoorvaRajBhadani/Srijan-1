...
public class Kavyanjali extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cardsList.add(new cards(R.color.card1, "Chai pe Charcha", value, R.drawable.chai));//yha pr salsa ki jagah event name or image bhi change krna
        cardsList.add(new cards(R.color.colorAccent, "Kavyanjali", "Grip Your Toes to Dance", R.drawable.kavyanjali));
        adapter = new adaptermain(Kavyanjali.this, cardsList);
