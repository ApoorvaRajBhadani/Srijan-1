...
public class dance extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cardsList.add(new cards(R.color.card1, "Salsa", value, R.drawable.footloose));//yha pr salsa ki jagah event name or image bhi change krna
        cardsList.add(new cards(R.color.colorAccent, "Footloose", "Grip Your Toes to Dance", R.drawable.footloose));
